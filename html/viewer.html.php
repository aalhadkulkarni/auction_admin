...
<head>
    ...
    <script>
        ...
        function setBiddingSummary() {
            ...
            if (status == "Bids") {
                alert("Bidding has started for " + currentPlayer.name + ". Teams are requested to submit their initial bid");
                biddingSummary += "<br>Teams are requested to submit their initial bid.";
                setTimeout(listenToBids, 5000);
                ...
                if (out == 3) {
                    alert("Last two teams remain. Bidding will now continue on whatsapp. Please check the updated bids and post on whatsapp.");
                    var inTeams = [];
                    for (var i in auctionState.leagueTeams) {
                    ...
                    alert("Admin has asked for raised bids.");
                biddingSummary += "<br>Teams are requested to submit their raised bid";
                }
                setTimeout(listenToBids, 5000);
            } else if (status == "Sold") {
